...
- **AI-coding archetypes and standards.** I built a personal tool to keep AI-generated code aligned with AT&T's internal standards. A VP on our side built a broader production archetype system (close cousins to agent skills) that's contributed to millions in AT&T-wide productivity gains. The production system is his; I'm a contributor. I've added archetypes and insights other engineers across AT&T now use. Four of mine landed as merged PRs (parallel agents via git worktrees, automated Playwright demos, git-history secret remediation, and a meta-archetype for building more archetypes), and I'm actively shipping more.
